...
// FollowButton component to handle following/unfollowing users
const FollowButton = ({ ownerId }) => {
    ...
    // Function to handle following/unfollowing user
    ...
    // Displaying follow button or following status based on logged status of user
